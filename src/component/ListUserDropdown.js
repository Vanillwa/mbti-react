      ...
      <Dropdown.Menu>
        ...
        {isLoggedIn && userInfo.userId != data.userId ? (
          <>
            <Dropdown.Item
              eventKey="2"
              onClick={e => handleRequestFreind(e, data.userId)}>
              친구 추가
            </Dropdown.Item>
            <Dropdown.Item
              eventKey="3"
              onClick={e => handleRequestChat(e, data.userId)}>
              채팅 요청
            </Dropdown.Item>
            <Dropdown.Item
              eventKey="4"
              onClick={e => handleRequestBlock(e, data.userId)}>
              차단하기
            </Dropdown.Item>
          </>
        ) : null}
...
export default ListUserDropdown;
